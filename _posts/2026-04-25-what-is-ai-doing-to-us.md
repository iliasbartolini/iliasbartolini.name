...
Modern "AI" started already running in that opposite direction. Training a frontier model takes hundreds of millions of pounds, access to copyrighted material, thousands of specialised chips, the kind of energy contracts that small countries negotiate, and rooms full of AI engineers that most companies can't afford to hire. The result is that the most powerful cognitive aiding tools ever built are sitting behind the doors of a handful of firms. Which they claim could already enable mass-scale security exploits, or that could guide autonomous weapons. 
...
But none of this is written in destiny. Technologies don't have a will of their own; they have owners, designers, and users, and the choices made by those people add up to the world the rest of us live in.
