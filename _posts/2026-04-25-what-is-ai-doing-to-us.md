...
Accessible and open foundation models matter. The more the cutting edge technology lives only inside closed corporate labs, the more we are asking a few executives to be wise on our behalf. It is important investing in open-source AI, supporting researchers who publish their AI evaluation methods, those who investigate bias, privacy and exploitation of "AI" models. Building guardrails and just update fast enough a legislation that is built on the existing human rights and moral codes. And finally resisting some of the framing that openness is _dangerous_ while closed development driven by a few responsible businesses and countries is the _solution_. 
